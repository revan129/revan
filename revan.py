...
#Code by Kontol
#Created 05-07-2020
#My facebook (https://www.facebook.com/kontol)
...
def yayanxd():
    ...
    if yayan == "": 
       os.system("python revan.py")
    else:
       sys.exit("\n\033[1;97m [\033[1;91m•\033[1;97m] \033[1;91mGood Bye:)")
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Kontol ID")
    ...
    if yayan == "1" or yayan =="01":
         ...
         if __name__ == '__main__':
               try:
                   ...
                   ikeh_ikeh_kimochi()
                   jembut()
                   print('\n\x1b[1;96m        REVAN AKBAR SEPTIADI
                   print('\x1b[1;95m     疊╔═╦═────••♽••────═╦═╗疊')
                   ...
                   ikeh_ikeh_kimochi()
                   jembut()
                   print('\n\x1b[1;92m        REVAN AKBAR SEPTIADI
                   print('\x1b[1;97m     疊╔═╦═────••♽••────═╦═╗疊')
